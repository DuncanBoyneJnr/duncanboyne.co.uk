				...
				<div>
					...
					{#if submitted}
						<div class="bg-success/10 border border-success/20 rounded-xl p-6 text-center">
							...
							<p class="text-muted">Thank you for reaching out. I typically reply within 1–2 business days.</p>
						</div>
					{:else}
						<form on:submit|preventDefault={handleSubmit} class="space-y-6">
							...
							>
								{#if submitting}
									<svg class="animate-spin w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true">
